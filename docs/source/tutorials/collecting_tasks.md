...
[`pytask collect`](../reference_guides/commands.md#pytask-collect) command.
...
task, append the
[`pytask collect --nodes`](../reference_guides/commands.md#pytask-collect--nodes) flag.
...
- Read the
    [command reference for `pytask collect`](../reference_guides/commands.md#pytask-collect).
