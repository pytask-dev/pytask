...
The tutorial
[defining dependencies products](../tutorials/defining_dependencies_products.md)
presented different ways to specify products. What might seem unintuitive at first is
that usually one would associate the return of functions with their products. But, none
of the approaches uses function returns.
